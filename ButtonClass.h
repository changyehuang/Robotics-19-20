...
void insertText(std::string text, int width, int height, int xi, int yi, int Ftype, int Fsize, int penHue, std::string penHex){
  ...
  switch(Ftype){
    case 0: switch(Fsize){
      case 12: Brain.Screen.setFont(vex::mono12);
        break;
      case 15: Brain.Screen.setFont(vex::mono15);
        break;
      case 20: Brain.Screen.setFont(vex::mono20);
        break;
      case 30: Brain.Screen.setFont(vex::mono30);
        break;
      case 40: Brain.Screen.setFont(vex::mono40);
        break;
    };
    break;

    case 1: switch(Fsize){
      case 20: Brain.Screen.setFont(vex::prop20);
        break;
      case 30: Brain.Screen.setFont(vex::prop30);
        break;
      case 40: Brain.Screen.setFont(vex::prop40);
        break;
      case 60: Brain.Screen.setFont(vex::prop60);
        break;
    };
    break;
